...
class Explosion{
	...
	public function explodeB() : bool{
		...
		$this->level->getServer()->getAsyncPool()->submitTask(new LightPopulationTask($this->level, $this->level->getChunk($this->source->x >> 4, $this->source->z >> 4)));
	...
	public function isInsideOfWater(){
		...
		$block = $this->level->getBlock((new Vector3(0, 0, 0))->setComponents(Math::floorFloat($this->source->x), Math::floorFloat($y = ($this->source->y)), Math::floorFloat($this->source->z)));
